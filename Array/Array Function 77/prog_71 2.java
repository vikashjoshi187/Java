...
public class prog_71 {
    ...
    prog_71(int arr[][],int row, int col) {
        this.arr = arr;
        this.row = row;
        this.col = col;
    }
    ...
    void identity() {
		...
		if (count == 0)
			System.out.println("Array is Lower Triangular Matrix ");
		else
			System.out.println("Array is Not a Lower Triangular Matrix ");
    }
	...
	public static void main(String[] args) {
        ...
        if (row == col) {
            ...
            prog_71 obj = new prog_71(arr,row,col);
            obj.getElement();
            obj.show();
            obj.identity();
        } else
