  ...
  public static void main(String[] args) {
    ...
    switch (ch) {
      ...
      case 98:
        ...
        for (int j = 1; j <= num; j++) {
					if (j == 1 || j == num && (i > 1 && i < num || i > num && i < num * 2 - 1) || i == 1 && j < num || i == num && j < num || i == num * 2 - 1 && j < num)
						System.out.print("* ");
					else
						System.out.print("  ");
				}
      ...
      for (int i = 1; i <= num*2-1; i++) {
        for (int j = 1; j <= num; j++) {
					if (j == 1 && i > 1 && i < num || i == 1 && j > 1 || i == num && j > 1)
						System.out.print("* ");
					else
						System.out.print("  ");
				}
      ...
      case 68:
       ...
       for (int i = 1; i <= num*2-1; i++) {
        for (int j = 1; j <= num; j++) {
					if ((i == num && j < num - num / 4) || j == 1 && i <= num || i == 1 && j < num - num / 4 || j == num - num / 4 && i > 1 && i < num)
						System.out.print("* ");
					else
						System.out.print("  ");
				}
      ...
      case 71:
        ...
        for (int i = 1; i <= num; i++) {
          for (int j = 1; j <= num; j++) {
            ...
            if (i==1 || i==num|| j==1|| i==(num/2)+1 && j>num/2 || j==num && i >num/2 ) {
              System.out.print("*");
