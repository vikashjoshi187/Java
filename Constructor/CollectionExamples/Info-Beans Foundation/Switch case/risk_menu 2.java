...
public class risk_menu {
    public static void main(String[] args) {
        ...
        int menu1, thli, thanu, sup, tm, veg, sutr = 0, dal = 0, rice, roti, ice, pds, pnd, crd, pns, chns, bfst, bft,snk,
                ktp, kti;
        String SUP = null, VEG = null, DAL = null, RICE = null, ROTI = null, ICE = null, PDS = null, PND = null,SNK=null,
                BFT = null, KTI = null,
        ...
        switch (menu1) {// SWITCH FOR MENU FOR MAIN MENU
            ...
            case 3: {// CASE FOR LADIES
                System.out.println(
                        "YOU SE =LECTED FOR For Ladies - Timing : 4 to 6pm After 6pm 20/- per hour/per head Extra)");
                System.out.println("ENTER 1 FOR Rs.250 PLATE\nENTER 2 FOR Rs.300 PLATE\nENTER 3 FOR Rs.350 PLATE\n ");
                ktp = sc.nextInt();

                System.out.println("YOU SELECTED Rs.250 PLATE");
                System.out.println(
                        "ENTER 1 FOR Soup oR Welcome DrinK\nENTER 2 FOR SACKES\nENTER 3 FOR Starter\nENTER 4 FOR Sweet Dish\nENTER 5 FOR Tea or Coffee");
                kti = sc.nextInt();
                switch (kti) {
                    case 1: {// CASE FOR Soup oR Welcome DrinK
                        ...
                        switch (ktp) {// SWITCH FOR KITTY PARTY
                            case 1: {// CASE FOR Rs.250 PLATE
                                break;
                            } // CASE FOR Soup oR Welcome DrinK ENDS

                            case 2: {// CASE FOR

                            }

                            default: {// DEFAULT FOR INVALID ITEM SELECTION
                                System.out.println("INVALID ITEM SELECTION");
                                System.exit(kti);
                                break;
                            } // DEFAULT FOR INVALID ITEM SELECTION
                        }

                        break;
                    } // CASE FOR SOUPS AND WELCOME DRINKS

                    case 2: {// CASE FOR Snacks
                        System.out.println("ENTER 1 FOR Idli/Vada Shambhar\nENTER 2 FOR \nENTER 3 FOR Pay Bhaii\nENTER 3 FOR Chhola Kulcha\nENTER 4 FOR Methi Paratha\nENTER 5 FOR Stuffed Paratha\nENTER 6 FOR Muli Paratha\nENTER 7 FOR Noodles\nENTER 8 FOR Chhole Bhatura\nENTER 9 FOR Chhola Poori\nENTER 10 FOR Paratha with Dahi\nENTER 11 FOR Aloo Paratha\nENTER 12 FOR \nENTER 13 FOR \nENTER 14 FOR \n");
                         snk=sc.nextInt();
                         switch (snk) {//SWITCH FOR SNACK
                            case 1:{
                         ...
                         }//SWITCH FOR SNACK ENDS


                    } // CASE FOR Snacks ENDS

                    default: {
                        System.out.println("INVALID ITEM SELECTE IN PALTE 1");
                        System.exit(99);
                        break;
                    }

                }// SWITCH FOR KITTY PARTY ENDS
                System.out.println(SUP);
                break;
            } // CASE FOR LADIES ENDS
