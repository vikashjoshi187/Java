...
class Fun { 
    public static String  Chooseveg (int a){
        String CVEG="";
        System.out.println("\033[H\033[2J");// COAMMAND FOR SCREEN CLEAR
        switch (a) {// SWITCH FOR VEFITABLES
            case 1: {
                CVEG = "\t\t Nav Ratan Korma" +"\n\t\t\t\t\t\t\t"+ "\u001B[0m";
                break;
            }
            case 2: {
                CVEG = "\t\t Lahori Aloo with Mutter" +"\n\t\t\t\t\t\t\t"+ "\u001B[0m";
                break;
            }
            case 3: {
                CVEG = "\t\t for Mix Veg" +"\n\t\t\t\t\t\t\t"+ "\u001B[0m";
            ...
            case 16: {
                CVEG = "\t\t VEGITABLE OF Chana Masala" +"\n\t\t\t\t\t\t\t"+ "\u001B[0m";
                break;
            }
            case 17: {
                CVEG = "\t\t Bhindi Masala" +"\n\t\t\t\t\t\t\t"+ "\u001B[0m";
    ...
    public static String  Choosesup (int a){
    System.out.println("\033[H\033[2J");// COAMMAND FOR SCREEN CLEAR
    String CSUP="";
                        switch (a) {// SWITCH FOR TYPES SOUP
                            case 1: {// CASE FOR TOMATO SOUP
                                CSUP = "\t\t TOMATO SOUP" + "\u001B[0m" + "\u001B[0m";
                                break;
    ...
    public static String  ChooseStrtr(int a){
        String CSUP="";     
        switch (a) {// SWITCH FOR TYPES SOUP
            case 1: {// CASE FOR TOMATO SOUP
                CSUP = "\t\t Blue Lagoon" + "\u001B[0m";
            ...
            case 2: {// CASE FOR VEG SOUP
                CSUP = "\t\t Blowgun Kesher Pista" + "\u001B[0m";
                break;
            } // CASE FOR VEG SOUP ENDS
            case 3: {// CASE FOR HOT AND SOUR VEG SOUP
                CSUP = "\t\t Fresh Lime Water" + "\u001B[0m";
                break;
            } // CASE FOR HOT AND SOUR VEG SOUP ENDS
            case 4: {// CASE FOR LEMON CORIENDER SOUP
                CSUP = "\t\t Butter Milk" + "\u001B[0m";
            ...
            case 5: {// CASE FOR LEMON CORIENDER SOUP
                CSUP = "\t\t Orange Pink City" + "\u001B[0m";
                break;
            } // CASE FOR LEMON CORIENDER SOUP ENDS
            case 6: {// CASE FOR LEMON CORIENDER SOUP
                CSUP = "\t\t Strawberry Delight" + "\u001B[0m";
                break;
            } // CASE FOR LEMON CORIENDER SOUP ENDS
    ...
    switch (a) {// SWITCH FOR ICE CREAM AND SWEET DISH
        ...
        public static String  ChooseStarter(int a){
        String CPDS="";
        switch (a) {
...
public class JMB_Fun {
    public static void main(String[] args) {
        Scanner sc = new Scanner(System.in);
        System.out.println("\t\t\t\t\t\t\tWELCOME TO JMB");
        int menu1, thli, sup, tm = 0, veg, sutr = 0, dal = 0, rice, roti, ice, pds, pnd, crd, pns, chns, bfst,mppl,ppl, snks, ktp, amt = 0, gamt = 0, eppl=0,eptm=0,tc=0;
        String SUP = "", date,VEG = "", DAL = "", RICE = "", ROTI = "", ICE = "", PDS = "", STRT = "", BFT = "", CRD = "",CHNS = "", TCI = "", SNKS = "",TC="";
...
////////////////////////////////TAKING DATE ///////////////////////////////////////////
    ...
    int count;
    System.out.println("\u001B[31m" +"\t\t\t\t\t\t\tEnter a date (format: dd/MM/yyyy) -> ");
    do {
        count = 0;
    date = sc.nextLine();
    LocalDate userEnteredDate=null;
    try{
    userEnteredDate = LocalDate.parse(date, formatter);
 
    }catch(Exception e){
        System.out.println("\u001B[31m" +"\t\t\t\t\t\t\tPlease enter date in proper format");
        count++;
        continue;
        }
    
    if (currentDate.isBefore(userEnteredDate)) {
        System.out.println("\u001B[31m" +"\t\t\t\t\t\t\tUser-entered date is in the future");
    } else {
        System.out.println("\u001B[31m" +"\t\t\t\t\t\t\t--Invalid Date...Please Re-Enter");
        count++;
    }
    } while (count > 0);
////////////////////////////////DATE ENDS ///////////////////////////////////////////
        ...
        switch (menu1) {// SWITCH FOR MENU FOR MAIN MENU
            case 1: {// CASE 1 FOR VEGETARIAN MENU
                ...
                if (thli == 6) {// IF CONDITION FOR THREE TYPE OF STARTER
                    ...
                    pds = sc.nextInt();
                    System.out.println("\033[H\033[2J");// COAMMAND FOR SCREEN CLEAR
                    STRT=Fun.ChooseStarter(pds);
                    System.out.println("\u001B[31m" +"\t\t\t\t\t\t\tSELECT STARTER 2\n"+ "\u001B[0m");
                    System.out.println("\u001B[35m"+ "\t\t\t\t\t\t\tENTER 1 FOR Mix Veg Pakoda\n\t\t\t\t\t\t\tENTER 2 FOR Veg Finger\n\t\t\t\t\t\t\tENTER 3 FOR Bread Pakoda\n\t\t\t\t\t\t\tENTER 4 FOR Methi Kabab\n\t\t\t\t\t\t\tENTER 5 FOR Paneer Pudina Tikkaa\n\t\t\t\t\t\t\tENTER 6 FOR Dragon Aloo\n\t\t\t\t\t\t\tENTER 7 FOR Saboo Dana\n\t\t\t\t\t\t\tENTER 8 FOR Finger Chips\n\t\t\t\t\t\t\tENTER 9 FOR Aloo Corn Kabab\n\t\t\t\t\t\t\tENTER 10 FOR Veg Cutlet\n\t\t\t\t\t\t\tENTER 11 FOR Veg Kothey\n\t\t\t\t\t\t\tENTER 12 FOR Hara Bhara Kabab \n\t\t\t\t\t\t\tENTER 13 FOR Corn Chat \n\t\t\t\t\t\t\tENTER 14 FOR Aloo Chat\n\t\t\t\t\t\t\tENTER 15 FOR Saboo Dana vada \n\t\t\t\t\t\t\tENTER 16 FOR Veg Manchurian Dry \n\t\t\t\t\t\t\tENTER 17 FOR Tandoori Manchurian \n\t\t\t\t\t\t\tENTER 18 FOR Chinese Corn Kebab"+ "\u001B[0m");
                    pds = sc.nextInt();
                    System.out.println("\033[H\033[2J");// COAMMAND FOR SCREEN CLEAR
                    STRT=STRT+Fun.ChooseStarter(pds);
                ...
                if (thli == 6 || thli == 7) {// IF CONDITION FOR PANEER STARTER
                    System.out.println("\u001B[35m" +"\t\t\t\t\t\t\tSELECT FOR PANEER STARTER" + "\u001B[0m");
                ...
                System.out.println("\u001B[31m" + "\t\t\t\t\t\t\t\t\t\tJMB BILL"+"\u001B[0m");
                System.out.println();
                System.out.println("\u001B[32m" + "\t\t\t\t\t\t\t                                                   Date:-"+date + "\u001B[0m");
                System.out.println("\u001B[32m" + "\t\t\t\t\t\t\t"+PDS + "\u001B[0m");
                System.out.println();
                System.out.println();
                System.out.println("\u001B[32m" + "\t\t\t\t\t\t\t"+SUP + "\u001B[0m");
                 System.out.println();
                System.out.println();

                System.out.println("\u001B[32m" + "\t\t\t\t\t\t\t"+VEG + "\u001B[0m");
                 System.out.println();
                System.out.println();

                System.out.println("\u001B[32m" + "\t\t\t\t\t\t\t"+DAL + "\u001B[0m");
                 System.out.println();
                System.out.println();

                System.out.println("\u001B[32m" + "\t\t\t\t\t\t\t"+RICE+ "\u001B[0m");
                 System.out.println();
                System.out.println();

                System.out.println("\u001B[32m" + "\t\t\t\t\t\t\t"+ROTI+ "\u001B[0m");
                 System.out.println();
                System.out.println();

                System.out.println("\u001B[32m" + "\t\t\t\t\t\t\t"+ICE + "\u001B[0m");
                 System.out.println();
                System.out.println();

                System.out.println("\u001B[32m" + "\t\t\t\t\t\t\t"+CRD + "\u001B[0m");
                 System.out.println();
                System.out.println();

                System.out.println("\u001B[32m" + "\t\t\t\t\t\t\t"+CHNS+ "\u001B[0m");
                 System.out.println();
                System.out.println();

                System.out.println("\u001B[32m" + "\t\t\t\t\t\t\t"+STRT+ "\u001B[0m");
                 System.out.println();
                System.out.println();

                System.out.println("\u001B[35m" +"\t\t\t\t\t\t\t-------------------------------------------------------------");
                System.out.println("\u001B[32m"+"\t\t\t\t\t\t\tNUMBER OF PEOPLE COME IN THE FUNCTION IS..................."+mppl+"\u001B[0m");
                System.out.println();
                System.out.println("\u001B[32m" + "\t\t\t\t\t\t\tEXTRA PRICE FOR EXTRA TIME IS..........................Rs."+eptm+"\u001B[0m");
                System.out.println();
                System.out.println("\u001B[32m"+ "\t\t\t\t\t\t\tTOTAL WITHOUT GST IS ..................................Rs."+amt+"\u001B[0m");
                System.out.println();
                System.out.println("\u001B[32m"+ "\t\t\t\t\t\t\tTOTAL WITH GST IS .....................................Rs."+gamt+"\u001B[0m");
                break;
            ...
            case 2: {// CASE FOR BRAKRFAST
                ...
                System.out.println("                           ");
                System.out.println("\u001B[35m" +"\t\t\t\t\t\t\t                                     Date:-"+date + "\u001B[0m");
                ...
                System.out.println("\u001B[35m" +"\t\t\t\t\t\t\tEXTRA PRICE FOR EXTRA TIMES IS ..............Rs."+eptm+ "\u001B[0m");
                System.out.println();
            ...
            case 3: {// CASE FOR MAIN LADIES
                ...
                if (ktp == 1 || ktp == 2) {// if for tea coffee
                    ...
                    System.out.println("\u001B[31m"+"SELECT SNAKS"+ "\u001B[0m");
                    ...
                    snks = sc.nextInt();
                    System.out.println("\033[H\033[2J");// COAMMAND FOR SCREEN CLEAR
                    SNKS=Fun.ChooseSnaks(snks);
                } // if for tea coffee ends
                else {// if for tea ior icecream ends
                    TCI = "YOU SELETED TEA OR ICECREAM";/// FOR 2 SNAKS
                ...
                System.out.println("\u001B[31m" + "\t\t\t\t\t\t\tSELECT FOR PANEER STARTER\n");
                System.out.println("\u001B[35m"+ "\t\t\t\t\t\t\tENTER 1 FOR Paneer Chilli\n\t\t\t\t\t\t\tENTER 2 FOR •Paneer Tikka\n\t\t\t\t\t\t\tENTER 3 FOR Dragon Paneer\n\t\t\t\t\t\t\tENTER 4 FOR Paneer 65\n\t\t\t\t\t\t\tENTER 5 FOR Paneer Pudina Tikkaa\n\t\t\t\t\t\t\tENTER 6 FOR Paneer Achari Tikka "+ "\u001B[0m");
                pns = sc.nextInt();
                PDS=Fun.ChoosePaneerS(pns);
                System.out.println("\033[H\033[2J");// COAMMAND FOR SCREEN CLEAR
                ...
                System.out.println();
                System.out.println();
                System.out.println("\u001B[35m" +"\t\t\t\t\t\t\t"+SNKS+"                                          ");
                System.out.println();
                System.out.println();
                System.out.println("\u001B[35m" +"\t\t\t\t\t\t\t"+ICE+"                                           ");
                System.out.println();
                System.out.println();
                System.out.println("\u001B[35m" +"\t\t\t\t\t\t\t"+PDS+"                                           ");
                System.out.println();
                System.out.println();
                System.out.println("\u001B[35m" +"\t\t\t\t\t\t\t"+SUP+"                                           ");
                System.out.println();
                System.out.println();
                System.out.println("\u001B[35m" +"\t\t\t\t\t\t\t"+TCI+"                                           ");
                System.out.println();
                System.out.println();
                System.out.println("\u001B[35m" +"\t\t\t\t\t\t\t---------------------------------------------------------- ");
                System.out.println("\u001B[35m" +"\t\t\t\t\t\t\tTOTAL PEOPLE ARRIVED .................................."+mppl);
                System.out.println();
                System.out.println("\u001B[35m" +"\t\t\t\t\t\t\tEXTRA PEOPLE ARRIVED .................................."+eppl);
                System.out.println();
                System.out.println("\u001B[35m" +"\t\t\t\t\t\t\tEXTRA PRICE FOR EXTRA PEOPLE .........................."+(eppl*20));
                System.out.println();
                System.out.println("\u001B[35m" +"\t\t\t\t\t\t\tEXTRA PRICE FOR EXTRA TIME IS ......................Rs." + eptm);
                System.out.println();
                System.out.println("\u001B[35m" +"\t\t\t\t\t\t\tTOTAL AMOUNT WITHOUT GST ...........................Rs." + amt);
                System.out.println();
                System.out.println("\u001B[35m" +"\t\t\t\t\t\t\tTOTAL AMOUNT WITH GST ..............................Rs." + gamt);
                break;
