...
public class QQQ {
    public static void main(String[] args) {
        ...
        switch (vcl) {
                            ...
                            case 1: {// CASE FOR FIRST FIVE DAYS
                                switch (tm) {
                                    case 1: { // CASE FOR PEAK TIME
                                        System.out.println("YOU HAVE ARRIVED ON PEAK HOURS THE AMOUNT OF TOLL APPILED ON YOUR VEHICLE IS Rs.13.75");
                                        break;
                                    } // CASE ENDS FOR PEAK TIME
                                    case 2: {// CASE FOR OFFF PEAK TIME
                                        System.out.println("YOU HAVE ARRIVED ON OFF PEAK HOURS THE AMOUNT OF TOLL APPILED ON YOUR VEHICLE IS Rs.11.75");
                                        break;
            ...
            ///////////////////////////////////////////////////////////CASE END FOR VEHICLE TYPE 1/////////////////////////////////////////////////////////////////////////////////////////////////////////
            
            ///////////////////////////////////////////////////////////CASE START FOR VEHICLE TYPE 2/////////////////////////////////////////////////////////////////////////////////////////////////////////
            case 2: {
                // TAKING WEEKDAY INPUT
                System.out.println(
                        "ENTER 1 FOR MONDAY\nTUESDAY\nWEDNESDAY\n ENTER 2 FOR \nTHRUSDAY\nENTER 3 FOR FRIDAY\nENTER 4 FOR \nSATURDAY\nENTER 5 FOR \nSUNDAY  ");
                    ...
                    case 1: {
                        ...
                        switch (wekd) {
                                ...
                                switch (tm) {
                                    ...
                                    case 3: {
                                        System.out.println("YOU ARRIVED ON OVERNIGHT TIME /nTHE TOLL APPILED ON YOUR VEHICLE IS Rs.33.00");
                                        break;
                                    }
                                    default: {// DEFAULT FOR INVALID TIME
                                        System.out.println("ENTER A VALID TIME");
                            ...
                            case 2: {// CASE FOR THRUSDAY
                                ...
                                switch (tm) {// SWITCH FOR TIME
                                    ...
                                    case 3: {// CASE FOR PEAK TIME
                                        System.out.println("YOU ARRIVED ON OVER NIGHT  TIME /nTHE TOLL APPILED ON YOUR VEHICLE IS Rs.33.00");
                                        break;
                                    } // CASE END FOR REAK TIME
            ...
            ///////////////////////////////////////////////////////////CASE END FOR VEHICLE TYPE 2/////////////////////////////////////////////////////////////////////////////////////////////////////////
          
///////////////////////////////////////////////////////////CASE START FOR VEHICLE TYPE 3/////////////////////////////////////////////////////////////////////////////////////////////////////////
            case 3: {
                // TAKING WEEKDAY INPUT
                System.out.println(
                        "ENTER 1 FOR MONDAY\nTUESDAY\nWEDNESDAY\n ENTER 2 FOR \nTHRUSDAY\nENTER 3 FOR FRIDAY\nENTER 4 FOR \nSATURDAY\nENTER 5 FOR \nSUNDAY  ");
                ...
                switch (ezps) {
                    ...
                    case 1: {
                        ...
                        case 1: {// CASE FOR MONDAY,TUESDAY,WEDNESDAY
                                ...
                                switch (tm) {
                                    case 1: {
                                        System.out.println("YOU ARRIVED ON PEAK TIME /nTHE TOLL APPILED ON YOUR VEHICLE IS Rs.57.00");
                                        break;
                                    }
                                    case 2: {
                                        System.out.println("YOU ARRIVED ON OFF PEAK TIME /nTHE TOLL APPILED ON YOUR VEHICLE IS Rs.54.00");
                                        break;
                                    }
                                    case 3: {
                                        System.out.println("YOU ARRIVED ON OVERNIGHT TIME /nTHE TOLL APPILED ON YOUR VEHICLE IS Rs.49.00");
                                        break;
                                    }
                                default: {// DEFAULT FOR INVALID TIME
                                        System.out.println("ENTER A VALID TIME");
                            ...
                            case 2: {// CASE FOR THRUSDAY
                                ...
                                switch (tm) {// SWITCH FOR TIME
                                    ...
                                    case 3: {// CASE FOR NIGHT TIME
                                        System.out.println("YOU ARRIVED ON OVER NIGHT  TIME /nTHE TOLL APPILED ON YOUR VEHICLE IS Rs.49.00");
                                        break;
                    ...
                    // DEFAULT FOR WHEN THE USER HAS NO EZPASS
                    default: {
                        System.out.println("NO EZPASS DETECTED AMOUNT PAYBALE IN CASH IS Rs.66.00");
                        break;
                    } // DEFAULT CASE ENS FOR WHEN THE USER HAS EZPASS
                }
                break;
            }
            ///////////////////////////////////////////////////////////CASE END FOR VEHICLE TYPE 3/////////////////////////////////////////////////////////////////////////////////////////////////////////
        
            ///////////////////////////////////////////////////////////CASE END FOR VEHICLE TYPE 4/////////////////////////////////////////////////////////////////////////////////////////////////////////
            case 4: {
                // TAKING WEEKDAY INPUT
                System.out.println("ENTER 1 FOR MONDAY\nTUESDAY\nWEDNESDAY\n ENTER 2 FOR \nTHRUSDAY\nENTER 3 FOR FRIDAY\nENTER 4 FOR \nSATURDAY\nENTER 5 FOR \nSUNDAY  ");
                wekd = sc.nextInt();
                // SWITCH SATRT FOR EZPASS
                switch (ezps) {//// CASE FOR WHEN THE USER HAS EZPASS
                    case 1: {
                        // SWITCH FOR WEEK
                        switch (wekd) {
                            case 1: {// CASE FOR MONDAY,TUESDAY,WEDNESDAY
                                ...
                                switch (tm) {
                                    case 1: {
                                        System.out.println("YOU ARRIVED ON PEAK TIME /nTHE TOLL APPILED ON YOUR VEHICLE IS Rs.76.00");
                                        break;
                                    }
                                    case 2: {
                                        System.out.println("YOU ARRIVED ON OFF PEAK TIME /nTHE TOLL APPILED ON YOUR VEHICLE IS Rs.72.00");
                                        break;
                                    }
                                    case 3: {
                                        System.out.println("YOU ARRIVED ON OVERNIGHT TIME /nTHE TOLL APPILED ON YOUR VEHICLE IS Rs.66.00");
                                        break;
                                    }
                                    default: {// DEFAULT FOR INVALID TIME
                                        System.out.println("ENTER A VALID TIME");
                            ...
                            case 2: {// CASE FOR THRUSDAY
                                ...
                                switch (tm) {// SWITCH FOR TIME
                                    ...
                                    case 3: {// CASE FOR NIGHT TIME
                                        System.out.println("YOU ARRIVED ON OVER NIGHT  TIME /nTHE TOLL APPILED ON YOUR VEHICLE IS Rs.66.00");
                                        break;
                                    } // CASE END FOR NIGHT TIME
                                    default: {// DEFAULT FOT INVALID TIME
                                        System.out.println("ENTER VALID TIME");
                            ...
                            case 4: {// CASE FOR SATURDAY
                                ...
                                switch (tm) {
                                    ...
                                    case 2: {
                                        System.out.println("YOU ARRIVED ON OFF PEAK TIME /nTHE TOLL APPILED ON YOUR VEHICLE IS Rs.73.00");
                                        break;
                                    }
                                    default: {// DEFAULT FOR INVALID TIME
                                        System.out.println("ENTER A VALID TIME");
                    ...
                    // DEFAULT FOR WHEN THE USER HAS NO EZPASS
                    default: {
                        System.out.println("NO EZPASS DETECTED AMOUNT PAYBALE IN CASH IS Rs.88.00");
                        break;
                    } // DEFAULT CASE ENS FOR WHEN THE USER HAS EZPASS
                }
                break;
         ...
         ///////////////////////////////////////////////////////////CASE END FOR VEHICLE TYPE 5/////////////////////////////////////////////////////////////////////////////////////////////////////////
         
         ///////////////////////////////////////////////////////////CASE START FOR VEHICLE TYPE 6/////////////////////////////////////////////////////////////////////////////////////////////////////////
            case 6: {
                // TAKING NUMBER OF ADDITIONAL AXELS
                System.out.println("ENTER NUMBER OF ADDITIONAL AXELS");
                axl = sc.nextInt();
                // TAKING WEEKDAY INPUT
                System.out.println(
                        "ENTER 1 FOR MONDAY\nTUESDAY\nWEDNESDAY\n ENTER 2 FOR \nTHRUSDAY\nENTER 3 FOR FRIDAY\nENTER 4 FOR \nSATURDAY\nENTER 5 FOR \nSUNDAY  ");
                ...
                switch (ezps) {
                    ...
                    case 1: {
                        ...
                        switch (wekd) {
                                ...
                                switch (tm) {
                                    case 1: {
                                        System.out.println(
                                                "YOU ARRIVED ON PEAK TIME /nTHE TOLL APPILED ON YOUR VEHICLE IS Rs."
                                                        + (144 + (axl * 19)));
                                        break;
                                    }
                                    case 2: {
                                        System.out.println(
                                                "YOU ARRIVED ON OFF PEAK TIME /nTHE TOLL APPILED ON YOUR VEHICLE IS Rs."
                                                        + (108 + (axl * 18)));
                                        break;
                                    }
                                    case 3: {
                                        System.out.println(
                                                "YOU ARRIVED ON OVERNIGHT TIME /nTHE TOLL APPILED ON YOUR VEHICLE IS Rs."
                                                        + (99 + (axl * 16.50)));
                                        break;
                                    }
                                    default: {// DEFAULT FOR INVALID TIME
                            ...
                            case 2: {// CASE FOR THRUSDAY
                                ...
                                switch (tm) {// SWITCH FOR TIME
                                    ...
                                    case 3: {// CASE FOR NIGHT TIME
                                        System.out.println(
                                                "YOU ARRIVED ON OVER NIGHT  TIME /nTHE TOLL APPILED ON YOUR VEHICLE IS Rs."
                                                        + (99 + (axl * 16.60)));
                                        break;
                                    } // CASE END FOR NIGHT TIME
                                    default: {// DEFAULT FOT INVALID TIME
                    ...
                    // DEFAULT FOR WHEN THE USER HAS NO EZPASS
                    default: {
                        System.out.println("NO EZPASS DETECTED AMOUNT PAYBALE IN CASH IS Rs." + (132 + (axl * 22)));
                        break;
                    } // DEFAULT CASE ENS FOR WHEN THE USER HAS EZPASS
                }
                break;
            }
           ///////////////////////////////////////////////////////////CASE END FOR VEHICLE TYPE 6/////////////////////////////////////////////////////////////////////////////////////////////////////////

           ///////////////////////////////////////////////////////////CASE START FOR VEHICLE TYPE 7/////////////////////////////////////////////////////////////////////////////////////////////////////////
            case 7: {
                // TAKING NUMBER OF ADDITIONAL AXELS
                System.out.println("ENTER NUMBER OF ADDITIONAL AXELS");
                axl = sc.nextInt();
                ...
                switch (ezps) {
                        ...
                        switch (wekd) {
                            case 1: {// CASE FOR FIRST FIVE DAYS
                                switch (tm) {
                                    case 1: { // CASE FOR PEAK TIME
                                        System.out.println(
                                                "YOU HAVE ARRIVED ON PEAK HOURS THE AMOUNT OF TOLL APPILED ON YOUR VEHICLE IS Rs."
                                                        + (24.25 + (axl * 10.50)));
                                        break;
                                    } // CASE ENDS FOR PEAK TIME
                                    case 2: {// CASE FOR OFFF PEAK TIME
                                        System.out.println(
                                                "YOU HAVE ARRIVED ON OFF PEAK HOURS THE AMOUNT OF TOLL APPILED ON YOUR VEHICLE IS Rs."
                                                        + (22.25 + (axl * 10.50)));
                                        break;
                                    } // CASE ENDS FOR OFF PEAK TIME
                                    default: {// DEFAULT FOR INVALID TIME
                    ...
                    default: {// DEFAULT CASE FOR NO EZPASS
                        System.out.println("THE AMOUNT OF TOLL APPILED ON YOUR VEHICLE IS Rs." + (34 + (axl * 18)));
                        break;
                    } // SWITCH ENDS FOR EZASS
                }
                break;
            }
           ///////////////////////////////////////////////////////////CASE END FOR VEHICLE TYPE 7/////////////////////////////////////////////////////////////////////////////////////////////////////////

          ///////////////////////////////////////////////////////////CASE START FOR VEHICLE TYPE 8-9/////////////////////////////////////////////////////////////////////////////////////////////////////////
            case 8:
            case 9: {
                // TAKING WEEKDAY INPUT
                System.out.println(
                        ...
                        switch (wekd) {
                            case 1: {// CASE FOR FIRST FIVE DAYS
                                switch (tm) {
                                    case 1: { // CASE FOR PEAK TIME
                                        System.out.println(
                                                "YOU HAVE ARRIVED ON PEAK HOURS THE AMOUNT OF TOLL APPILED ON YOUR VEHICLE IS Rs.14");
                                        break;
                                    } // CASE ENDS FOR PEAK TIME
                                    case 2: {// CASE FOR OFFF PEAK TIME
                                        System.out.println(
                                                "YOU HAVE ARRIVED ON OFF PEAK HOURS THE AMOUNT OF TOLL APPILED ON YOUR VEHICLE IS Rs.14");
                                        break;
                                    } // CASE ENDS FOR OFF PEAK TIME
                                    default: {// DEFAULT FOR INVALID TIME
                                        System.out.println("ENTER A VALID TIME");
            ...
            ///////////////////////////////////////////////////////////CASE END FOR VEHICLE TYPE 8-9/////////////////////////////////////////////////////////////////////////////////////////////////////////
            
            ///////////////////////////////////////////////////////////CASE START FOR VEHICLE TYPE 10/////////////////////////////////////////////////////////////////////////////////////////////////////////
            case 10: {
                // TAKING WEEKDAY INPUT
                System.out.println(
                        "ENTER 1 FOR MONDAY\nTUESDAY\nWEDNESDAY\nTHRUSDAY\nFRIDAY\n\nENTER 2 FOR \nSATURDAY\nSUNDAY  ");
                        ...
                        switch (wekd) {
                            case 1: {// CASE FOR FIRST FIVE DAYS
                                switch (tm) {
                                    case 1: { // CASE FOR PEAK TIME
                                        System.out.println(
                                                "YOU HAVE ARRIVED ON PEAK HOURS THE AMOUNT OF TOLL APPILED ON YOUR VEHICLE IS Rs.10");
                                        break;
                                    } // CASE ENDS FOR PEAK TIME
                                    case 2: {// CASE FOR OFFF PEAK TIME
                                        System.out.println(
                                                "YOU HAVE ARRIVED ON OFF PEAK HOURS THE AMOUNT OF TOLL APPILED ON YOUR VEHICLE IS Rs.12");
                                        break;
                                    } // CASE ENDS FOR OFF PEAK TIME
                                    default: {// DEFAULT FOR INVALID TIME
                                        System.out.println("ENTER A VALID TIME");
